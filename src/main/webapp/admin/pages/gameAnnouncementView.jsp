...
<div class="main_right"  id="main_col1"  style="overflow:hidden;">
	<div class="hangy_qh2">
		<ul class="TabbedPanelsTabGroup">
			<li class="TabbedPanelsTab TabbedPanelsTabSelected" >查看赛事公告</li>
		</ul>
				...
				<ul class="tongdao">
					<li>
						...
						<div class="wen">
							...
							<c:out value="${gameAnnouncement.annoTitle }" escapeXml="false"/>
					...
					<li>
						<div class="wen">
							<input type="button" class="button_tongdao" value="关闭" onclick="javascript:window.close();">
						</div>
					</li>
				</ul>
			</form>
