					...
					success : function(data) {
						...
						for(var i = 0; i < data.length; i++) {
							...
							(function(album,picUrl){
								li = $('<li style="overflow:hidden;margin-bottom:2px;"><a><img src=""></a></li>');
								$('#add').before(li);
		...
		<div class="TabbedPanelsContent">
				...
				<ul class="qd_sctp">
						<c:forEach items="${albumList}" var="album">
							<li style="overflow:hidden;margin-bottom:2px;"><a href="javascript:PageUtil.preview('<c:out value="${domain }" /><c:out value="${album.pic }" />');void 0;" id="<c:out value="${album.id }" />"><img src="<c:url value="${album.pic }" />"></a></li>
							<script type="text/javascript">
