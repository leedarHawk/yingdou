...
<div class="header"><span><a href="javascript:history.go(-1);void 0;"><img src="<c:url value="/site/images/jt_fh.png" />">返回</a></span><c:if test="${user.sex=='男' }">他</c:if><c:if test="${user.sex=='女' }">她</c:if><font></font></div>
<div class="main">
	<dl class="hy_topdl">
	...
	<div id="TabbedPanels2" class="hangy_qh3">
		<ul class="TabbedPanelsTabGroup">        
			<li class="TabbedPanelsTab" tabindex="0" style="border:0;"><c:if test="${user.sex=='男' }">他</c:if><c:if test="${user.sex=='女' }">她</c:if>的比赛</li>
			<li class="TabbedPanelsTab" tabindex="0"><c:if test="${user.sex=='男' }">他</c:if><c:if test="${user.sex=='女' }">她</c:if>的球局</li>
			<li class="TabbedPanelsTab" tabindex="0"><c:if test="${user.sex=='男' }">他</c:if><c:if test="${user.sex=='女' }">她</c:if>的球队<!-- <span>1</span> --></li>
		</ul>
