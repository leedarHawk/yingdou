...
<div class="header"><span><a href="<%-- <c:url value="/site/game/list" /> --%>javascript:history.go(-1);void 0;"><img src="<c:url value="/site/images/jt_fh.png" />">返回</a></span></div>
<div class="main3">
		...
		<div class="TabbedPanelsContentGroup">
			...
			<div class="TabbedPanelsContent">
				...
				<c:forEach items="${gameAnnouncementList}" var="gameAnnouncement">
					<div class="ph_ggart">
						<a href="<c:url value="/site/game/announcement/detail/${gameAnnouncement.id }" />"><c:out value="${gameAnnouncement.annoTitle}" escapeXml="false" /></a>
